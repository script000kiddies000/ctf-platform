      ...
      <div class="col-md-12">
        ...
        <div class="panel panel-default panel-fill">
          ...
          <div class="panel-body">
            ...
            <form class="form-horizontal m-t-20" method="POST" action="information-add.php">
                ...
                <div class="col-xs-12">
                    ...
                    <textarea class="form-control" rows="3" type="text" name="informasi" required="" placeholder="Add New Information"></textarea>
              ...
              <div class="form-group">
                ...
                <div align="right" class="col-xs-12">
                    ...
                    <br/><button type="submit" class="btn waves-effect waves-light btn-primary"><b class="md-add-circle"></b> Add Information</button>
